...
if (!class_exists('HRR_Plugin_Update_Checker')) {
    ...
    /**
     * HRR_Plugin_Update_Checker Class
     * */
    class HRR_Plugin_Update_Checker {
        ...
        /**
         * HRR_Plugin_Update_Checker Class Initialization
         * */
        ...
        public function plugin_update_row($plugin_data, $response) {
            ...
            if (isset($response->warning_message) && $response->warning_message == '5006') {
                printf(__('There is a new version of %1$s available.<em>Automatic update is unavailable for this plugin.</em>'), $packages->new_version);
            }
        }
